...
res.send("API Token Revoked").end();
})
...
/* GET Countries page. */
router.get('/countries', verifyJWT, async (req, res) => {
...
router.get('/country/:code', verifyJWT, async (req, res) => {
  ...
  router.post('/country', verifyJWT, async (req, res) => {
  ...
  router.patch('/country/:code', verifyJWT, async (req, res) => {
    const code = req.params.code;
    const country = {};
  ...
  router.delete('/country/:code', verifyJWT, async (req, res) => {
    const code = req.params.code;
    try {
